...
public class DwCSciNameDQ_stubs {
    ...
    public DQResponse<ComplianceValue> validationClassFound(@ActedUpon("dwc:class") String class) {
        DQResponse<ComplianceValue> result = new DQResponse<ComplianceValue>();
