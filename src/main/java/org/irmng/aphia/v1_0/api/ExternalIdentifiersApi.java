...
public class ExternalIdentifiersApi {
    ...
    private com.squareup.okhttp.Call aphiaExternalIDByIRMNGIDValidateBeforeCall(Integer ID, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'ID' is set
        if (ID == null) {
            throw new ApiException("Missing the required parameter 'ID' when calling aphiaExternalIDByIRMNGID(Async)");
        }
        
        com.squareup.okhttp.Call call = aphiaExternalIDByIRMNGIDCall(ID, type, progressListener, progressRequestListener);
        return call;
    ...
    public com.squareup.okhttp.Call aphiaExternalIDByIRMNGIDAsync(Integer ID, String type, final ApiCallback<List<String>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = aphiaExternalIDByIRMNGIDValidateBeforeCall(ID, type, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
